-- SPECATHON 2026 · V2 — Add strict email column to shortlisted_teams
...
alter table public.shortlisted_teams
  drop constraint if exists shortlisted_teams_email_check;

alter table public.shortlisted_teams
  add constraint shortlisted_teams_email_check 
  check (email ~* '^[A-Za-z0-9._%-]+@[A-Za-z0-9.-]+[.][A-Za-z]+$');

-- ── 3. Replace import_shortlisted_teams() to require and validate email ────────

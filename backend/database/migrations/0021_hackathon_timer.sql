-- SPECATHON 2026 · Migration 0021: Hackathon Event Timer & Timeline
-- Creates authoritative tables for event clock, metro-timeline checkpoints,
-- real-time synchronization, and administrative audit logging.
...
-- Seed single row if not already present
...
-- Seed initial SPECATHON 2026 milestones if table is empty
do $$
begin

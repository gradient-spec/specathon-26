/**
 * Ferrofluid — WebGL background from ReactBits.
 * Adapted to TypeScript; source and shaders unchanged.
 */
  ...
  useEffect(() => {
    ...
    const loop = (t: number) => {
      ...
      if (mouseDampening > 0) {
        ...
        const cur = uniforms.iMouse.value as unknown as [number, number];
    ...
    return () => {
      ...
      const callIfFn = (obj: unknown, key: string) => {
        ...
        const fn = (obj as any) && (obj as any)[key];
